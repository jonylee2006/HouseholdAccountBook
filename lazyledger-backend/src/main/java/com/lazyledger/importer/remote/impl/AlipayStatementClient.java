...
public class AlipayStatementClient implements RemoteStatementClient {

    private final WebClient webClient;
    private final RemoteStatementProperties.Provider properties;

    public AlipayStatementClient(WebClient webClient, RemoteStatementProperties.Provider properties) {
    ...
    public InputStream fetch(ImportAuthorization authorization, LocalDate billDate) {
        ...
        byte[] content = webClient.get()
                ...
                .headers(headers -> headers.set("Authorization", "Bearer " + authorization.getAccessToken()))
                .retrieve()
